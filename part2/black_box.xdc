...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { data }]; #IO_L23P_T3_35 Sch=led[0]
...
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { seq_detected}]; #IO_L6N_T0_VREF_35 Sch=led6_g
